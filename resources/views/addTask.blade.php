        ...
        <div class="row ">
                ...
                <nav class="nav-bar-items">
                    <ul>
                        ...
                        <li class="items" style="cursor: pointer;">
                            <a href="/" class="nav-bar-link"><img src="{{asset('img/project.png')}}" alt="Project" class="nav-bar-icon"><span class="nav-bar-text">
                                    Projects
                                </span></a>
                        </li>
            ...
            <div class="create-project col-9">
                ...
                <form method="POST" class="create-project-info" action="{{ route('addTask') }}">
                    ...
                    <textarea name="task_description" id="project-description" cols="60" rows="5" class="create-project-input-description"></textarea>
